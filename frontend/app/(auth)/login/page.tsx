  ...
  return (
    <div className="min-h-screen bg-muted flex flex-col">
      ...
      <header className="flex items-center justify-between px-8 py-4 bg-background border-b border-border">
        ...
        <Link href="/register">
          <Button variant="outline" className="calendly-btn-hover" id="login-get-started">
            Get started
          </Button>
        </Link>
      </header>
      ...
      {/* Main content */}
      <main className="flex-1 flex flex-col items-center justify-center px-4 py-12 animate-calendly-fade-in">
        <h1 className="text-3xl font-bold text-foreground mb-8 tracking-tight">
          Log in to your account
        </h1>

        <div className="w-full max-w-[450px] bg-card rounded-2xl shadow-calendly p-10">
          {/* Email form */}
