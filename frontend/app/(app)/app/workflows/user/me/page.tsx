...
import { GitBranch, Plus, Info, Zap, Mail, Bell } from "lucide-react";
    ...
    <div className="flex flex-col gap-6 w-full max-w-[1000px]">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          <h1 className="text-[20px] font-bold text-[#1A1A1A]">Workflows</h1>
      ...
      <div className="flex items-center gap-6 border-b border-[#D9D9D9] text-[14px] font-medium">
        ...
        <button className="pb-3 text-[#666666] hover:text-[#1A1A1A] transition-colors">
          Templates
        </button>
      </div>
      ...
      <div className="border border-[#E5E5E5] rounded-xl bg-white shadow-sm">
        <div className="flex flex-col items-center justify-center py-20 text-center px-6">
          <div className="w-20 h-20 bg-gradient-to-br from-[#E5F1FF] to-[#F0F4FF] rounded-full flex items-center justify-center mb-6 relative">
            <GitBranch className="size-10 text-[#006BFF]" strokeWidth={1.5} />
          </div>
          ...
          <p className="text-[14px] text-[#666666] mb-8 max-w-[440px]">
            Create workflows to automate communications before and after your events — send emails, reminders, follow-ups, and more.
          </p>
